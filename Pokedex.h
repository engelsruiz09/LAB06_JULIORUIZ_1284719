...
namespace LAB06JULIORUIZ1284719 {
	...
	#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lbxPokedex->Location = System::Drawing::Point(53, 101);
			this->lbxPokedex->Margin = System::Windows::Forms::Padding(2);
			this->lbxPokedex->Name = L"lbxPokedex";
			this->lbxPokedex->Size = System::Drawing::Size(191, 264);
			...
			this->cbxParametro->Location = System::Drawing::Point(321, 130);
			this->cbxParametro->Margin = System::Windows::Forms::Padding(2);
			this->cbxParametro->Name = L"cbxParametro";
			this->cbxParametro->Size = System::Drawing::Size(125, 26);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(297, 101);
			...
			this->cbxMetodo->Location = System::Drawing::Point(321, 198);
			this->cbxMetodo->Margin = System::Windows::Forms::Padding(2);
			this->cbxMetodo->Name = L"cbxMetodo";
			this->cbxMetodo->Size = System::Drawing::Size(125, 26);
			...
			this->btnOrdenar->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnOrdenar->Location = System::Drawing::Point(330, 228);
			this->btnOrdenar->Margin = System::Windows::Forms::Padding(2);
			this->btnOrdenar->Name = L"btnOrdenar";
			this->btnOrdenar->Size = System::Drawing::Size(100, 31);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(297, 270);
			...
			this->lblTiempo->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lblTiempo->Location = System::Drawing::Point(389, 270);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(285, 168);
			this->label3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(104, 18);
			this->label3->TabIndex = 8;
			this->label3->Text = L"Busqueda por:";
			// 
			// Pokedex
			// 
			...
			this->ClientSize = System::Drawing::Size(527, 416);
